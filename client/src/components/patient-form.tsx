...
export function PatientForm({ 
  ...
  const samplePatientData = [
    ...
    "Patient diagnosed with Congestive Heart Failure (CHF) with reduced ejection fraction (HFrEF) and atrial fibrillation, currently prescribed Furosemide 40mg twice daily for fluid overload, Carvedilol 6.25mg twice daily for heart failure management, Sacubitril/Valsartan 49/51mg twice daily for HFrEF, Apixaban 5mg twice daily for stroke prevention, and Spironolactone 25mg once daily for heart failure. Recovery plan includes strict fluid restriction to 1.5 liters daily, low-sodium diet (<2g/day), daily weight monitoring to detect fluid retention, 20 minutes of supervised cardiac rehabilitation exercises 3 days per week, and biannual echocardiogram to assess cardiac function. Patient education needed on medication adherence, signs of worsening heart failure (e.g., dyspnea, edema), bleeding risks with Apixaban, and importance of potassium monitoring due to Spironolactone.",
    "Patient diagnosed with Advanced Heart Failure (NYHA Class III), Atrial Fibrillation with rapid ventricular response, and Chronic Kidney Disease (CKD) Stage 3. Currently prescribed Diltiazem ER 240mg once daily for rate control, Digoxin 0.125mg once daily for heart failure and atrial fibrillation, Ivabradine 5mg twice daily to reduce heart rate, Torsemide 20mg once daily for diuresis, and Amiodarone 200mg once daily for rhythm stabilization. Recovery plan includes strict fluid restriction to 1.2 liters daily, low-potassium and low-sodium diet (<1.5g sodium/day), daily self-monitoring of blood pressure and pulse, 15-minute low-intensity cardiac rehabilitation exercises 4 days per week, and quarterly renal function and thyroid panel monitoring due to Amiodarone. Patient education needed on recognizing signs of Diltiazem-related hypotension, Digoxin toxicity (e.g., nausea, visual changes), Amiodarone side effects (e.g., photosensitivity, pulmonary toxicity), dietary compliance, and importance of adhering to follow-up labs for CKD management."
  ];
